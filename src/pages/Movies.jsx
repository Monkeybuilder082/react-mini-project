...
const Movies = () => {
  ...
  const movieSorted = (keyword, sortMethod) => {
    ...
    // 정렬된 배열을 state에 다시 초키화해주면 영화정보가 정렬되어 출력된다.
    let list = [...filter]
    let result = []
              ...
              <Accordion.Item eventKey="0">
                ...
                <Accordion.Body>
                  <Dropdown>
                    ...
                    <Dropdown.Menu>
                      <Dropdown.Item href="#/action-1" onClick={()=> movieSorted('평점', 'asc')}>평점 오름차순</Dropdown.Item>
                      <Dropdown.Item href="#/action-2" onClick={()=> movieSorted('평점', 'desc')}>평점 내림차순</Dropdown.Item>
                      <Dropdown.Item href="#/action-3" onClick={()=> movieSorted('인기도', 'asc')}>인기도 오름차순</Dropdown.Item>
                      <Dropdown.Item href="#/action-1" onClick={()=> movieSorted('인기도', 'desc')}>인기도 내림차순</Dropdown.Item>
                      <Dropdown.Item href="#/action-2" onClick={()=> movieSorted('제목', 'asc')}>제목 오름차순</Dropdown.Item>
                      <Dropdown.Item href="#/action-3" onClick={()=> movieSorted('제목', 'desc')}>제목 내림차순</Dropdown.Item>
                    </Dropdown.Menu>
                  </Dropdown>
                </Accordion.Body>
              </Accordion.Item>
